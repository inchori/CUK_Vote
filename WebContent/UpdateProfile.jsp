				...
				<div class="container">
					...
					<div class="collapse navbar-collapse navbar-responsive-collapse">
						<ul class="nav navbar-nav">
							...
							<li><a href="bbsview.jsp">게시판</a></li>
						...
						<tbody>
							<tr>
								...
								<td><input class="form-control" type="text" id="ID"
									name="ID" value="${student.ID}" maxLength="20" disabled></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="2"><input class="form-control" type="text"
									id="name" name="name" value="${student.name}" maxLength="20"
									disabled></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="2"><input class="form-control" type="text"
									id="brithday" name="birthday" value="${student.birthday}"
									maxLength="20" placeholder="생년월일"></td>
							</tr>
							<tr>
								<c:choose>
									<c:when test="${student.gender == '남자'}">
											...
											<div class="form-group"
												...
												<div class="btn-group" data-toggle="buttons">
													<label class="btn btn-primary active"> <input
														...
														type="radio" name="gender" autocomplete="off" value="여자">여자
													</label>
												</div>
											</div>
										</td>
									...
									<c:otherwise>
										...
										<td colspan="2">
											<div class="form-group"
												...
												<div class="btn-group" data-toggle="buttons">
													<label class="btn btn-primary active"> <input
														type="radio" name="gender" autocomplete="off" value="남자">남자
													</label> <label class="btn btn-primary"> <input
														type="radio" name="gender" autocomplete="off" value="여자"
														checked>여자
													</label>
												</div>
											</div>
							...
							<tr />
							<tr>
								<td style="width: 120px"><h5>학과</h5></td>
								<td colspan="2">
									<div class="form-group">
							...
							<tr>
								...
								<td colspan="2"><input class="form-control" type="text"
									...
									value="${student.phoneNumber}" placeholder="휴대폰 번호"></td>
							</tr>
							<tr>
								...
								<td colspan="2"><input class="form-control" type="email"
									...
									value="${student.mailAddress}" placeholder="이메일"></td>
							</tr>
							<tr>
